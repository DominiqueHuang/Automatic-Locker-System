...
class BoxUI:
    ...
    def show_main01(self):
        background = self.make.make_background("assets/background1.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/login.png"))
        ...
        b1, b1.image = self.make.make_buton(
            "assets/signup_now.png", self.switch_to_register_user
        )
        b1.place(x=764, y=683, width=104, height=19)

        b3, b3.image = self.make.make_buton(
            "assets/iamcourier.png", self.switch_to_courier_menu
        )
        b3.place(x=651, y=710, width=126, height=19)

        b4, b4.image = self.make.make_buton(
            "assets/iamadmin.png", self.switch_to_operator_menu
        )
        b4.place(x=654, y=737, width=128, height=20)

        entry0, entry0.image = self.make.make_entry("assets/img_textBox0.png", 738.5, 446.0)
        entry0.place(x=609, y=429, width=259, height=32)

        entry1, entry1.image = self.make.make_entry("assets/img_textBox1.png", 738.5, 520.0)
    ...
    def show_main02(self):  # wrong id or pass
        background = self.make.make_background("assets/background2.png")
        ...
        b4, b4.image = self.make.make_buton(
            "assets/iamadmin.png", self.switch_to_operator_mode
        )
        b4.place(x=654, y=737, width=128, height=20)
    ...
    def show_retrieve_package(self, locker_id):
        background = self.make.make_background("assets/background22.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/closebox.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
    ...
    def show_courier1(self):  # open box
        background = self.make.make_background("assets/background3.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/openbox.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.deliver_package(entry0.get(), entry1.get().upper(), self.req_size),
            relief="flat",
        )
        b0.place(x=280, y=690, width=190, height=44)

        b1, b1.image = self.make.make_buton("assets/big.png", self.request_big)
        b1.place(x=184, y=621, width=115, height=38)

        b2, b2.image = self.make.make_buton("assets/med.png", self.request_med)
        b2.place(x=315, y=621, width=115, height=38)

        b3, b3.image = self.make.make_buton("assets/sml.png", self.request_sml)
        b3.place(x=452, y=621, width=115, height=38)

        b4, b4.image = self.make.make_buton("assets/home.png", self.back_to_main)
        b4.place(x=1315, y=17, width=90, height=93)

        entry0, entry0.image = self.make.make_entry("assets/img_textBox0.png", 385.5, 452.0)
        entry0.place(x=256, y=435, width=259, height=32)

        entry1, entry1.image = self.make.make_entry("assets/img_textBox0.png", 389.5, 546.0)
    ...
    def show_courier2(self, locker_id, id, item_type, item_size):  # close box
        background = self.make.make_background("assets/background4.png")
    ...
    def show_courier3(self, invalid_id):  # invalid id
        background = self.make.make_background("assets/background5.png")
    ...
    def show_courier4(self):  # box full
        background = self.make.make_background("assets/background6.png")
    ...
    def show_sign_up1(self):
        background = self.make.make_background("assets/background7.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/signup.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
        ...
        entry0, entry0.image = self.make.make_entry("assets/img_textBox0.png", 733.5, 473.0)
        entry0.place(x=604, y=456, width=259, height=32)

        entry1, entry1.image = self.make.make_entry("assets/img_textBox1.png", 737.5, 567.0)
        entry1.place(x=608, y=550, width=259, height=32)

        entry3, entry3.image = self.make.make_entry("assets/img_textBox2.png", 739.5, 657.0)
    ...
    def show_sign_up2(self):  # email taken
        background = self.make.make_background("assets/background8.png")
    ...
    def show_sign_up3(self):  # invalid email add
        background = self.make.make_background("assets/background9.png")
    ...
    def show_sign_up4(self):  # succ sign up
        background = self.make.make_background("assets/background20.png")
    ...
    def show_sign_up5(self):    # Password too short
        background = self.make.make_background("assets/background23.png")
    ...
    def show_open_locker1(self):  # after login
        background = self.make.make_background("assets/background10.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/openlocker.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.retrieve_package(self.current_user, entry0.get(), entry1.get()),
            relief="flat",
        )
        ...
        entry0, entry0.image = self.make.make_entry("assets/img_textBox0.png", 734.5, 517.0)
        entry0.place(x=605, y=500, width=259, height=32)

        entry1, entry1.image = self.make.make_entry("assets/img_textBox1.png", 734.5, 591.0)
    ...
    def show_open_locker2(self):  # wrong ver code or locker id
        background = self.make.make_background("assets/background11.png")
    ...
    def show_open_locker3(self):  # wrong ver code or locker id
        background = self.make.make_background("assets/background12.png")
    ...
    def show_operator_sign_in1(self):
        background = self.make.make_background("assets/background13.png")
        ...
        entry0, entry0.image = self.make.make_entry("assets/img_textBox0.png", 738.5, 513.0)
        entry0.place(x=609, y=500, width=259, height=32)

        entry1, entry1.image = self.make.make_entry("assets/img_textBox1.png", 738.5, 587.0)
    ...
    def show_operator_sign_in2(self):  # wrong op id or pass
        background = self.make.make_background("assets/background14.png")
    ...
    def show_operator_mode1(self):  # op menu
        background = self.make.make_background("assets/background15.png")

        b0, b0.image = self.make.make_buton("assets/deleteacc.png", self.switch_to_delete_acc)
        b0.place(x=609, y=549, width=222, height=44)

        b1, b1.image = self.make.make_buton("assets/report.png", self.switch_to_report)
        b1.place(x=609, y=629, width=222, height=44)

        b2, b2.image = self.make.make_buton("assets/registerop.png", self.switch_to_regist_op)
    ...
    def show_regis_op1(self):
        background = self.make.make_background("assets/background16.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/register.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
        ...
        b5, b5.image = self.make.make_buton("assets/back.png", self.switch_to_operator_menu)
    ...
    def show_regis_op2(self):  # succ making new op
        background = self.make.make_background("assets/background18.png")
    ...
    def show_regis_op3(self):   # Invalid operator pass
        background = self.make.make_background("assets/background24.png")
    ...
    def show_regis_op4(self):   # Invalid operator id
        background = self.make.make_background("assets/background25.png")
    ...
    def show_delete_user1(self):
        background = self.make.make_background("assets/background17.png")

        b0_image = PhotoImage(file=self.make.relative_to_assets("assets/deleteuser.png"))
        b0 = Button(
            image=b0_image,
            borderwidth=0,
            highlightthickness=0,
    ...
    def show_delete_user2(self):    # Invalid name or email
        background = self.make.make_background("assets/background21.png")
    ...
    def show_delete_user3(self):  # succ delete user
        background = self.make.make_background("assets/background19.png")
    ...
    def show_report(self):
        ...
        b4_image = PhotoImage(file=self.make.relative_to_assets("assets/home2.png"))
        b4 = Button(
            image=b4_image,
            borderwidth=0,
            highlightthickness=0,
        ...
        b5_image = PhotoImage(file=self.make.relative_to_assets("assets/back2.png"))
        b5 = Button(
            image=b5_image,
            borderwidth=0,
            highlightthickness=0,
        ...
        b6_image = PhotoImage(file=self.make.relative_to_assets("assets/report2.png"))
        b6 = Button(
            image=b6_image,
            borderwidth=0,
            highlightthickness=0,
